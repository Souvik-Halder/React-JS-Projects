    ...
    <div name="home" className='h-screen w-full bg-gradient-to-b from-black to-gray-800 via-black'>
        <div className='max-w-screen-lg mx-auto flex flex-col items items-center justify-center h-full px-4 md:flex-row'>
            <div className='flex flex-col justify-center h-full'>
                ...
                <div className=''><button className='bg-gradient-to-r from-cyan-500 to-blue-500 text-white w-fit  px-6 py-4 mt-4 flex items-center rounded-md cursor-pointer my-3'>
                    Portfolio <span className='px-3 group-hover:rotate-90 duration-300'><AiOutlineArrowRight className='ml-1' /></span> </button>
                    </div>
            </div>
            <div>
